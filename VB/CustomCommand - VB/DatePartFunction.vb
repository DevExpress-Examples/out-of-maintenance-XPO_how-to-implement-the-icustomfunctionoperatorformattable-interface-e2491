...
Namespace DXSample
	Public Class GetMonthFunction
		...
		Private Function ICustomFunctionOperator_Evaluate(ParamArray ByVal operands() As Object) As Object Implements ICustomFunctionOperator.Evaluate
			Return GetMonth(DirectCast(operands(0), DateTime))
		End Function
		...
		Private Function ICustomFunctionOperatorQueryable_GetMethodInfo() As MethodInfo Implements ICustomFunctionOperatorQueryable.GetMethodInfo
